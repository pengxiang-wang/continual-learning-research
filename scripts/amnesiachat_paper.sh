...
do
# Independent
clarena pipeline=CUL_FULL_EXPR index=amnesiachat_paper/independent_pmnist_5tasks cl_paradigm=TIL output_dir=output_amnesiachat_paper/main_study/pmnist_5tasks_til/independent/seed_${global_seed} global_seed=${global_seed}
# Finetuning
clarena pipeline=CUL_FULL_EXPR index=amnesiachat_paper/finetuning_pmnist_5tasks cl_paradigm=TIL output_dir=output_amnesiachat_paper/main_study/pmnist_5tasks_til/finetuning/seed_${global_seed} global_seed=${global_seed}
# LwF
...
do
# Independent
clarena pipeline=CUL_FULL_EXPR index=amnesiachat_paper/independent_smnist_5tasks cl_paradigm=TIL output_dir=output_amnesiachat_paper/main_study/smnist_5tasks_til/independent/seed_${global_seed} global_seed=${global_seed}
# Finetuning
...
do
# Independent
clarena pipeline=CUL_FULL_EXPR index=amnesiachat_paper/independent_rmnist_5tasks cl_paradigm=TIL output_dir=output_amnesiachat_paper/main_study/rmnist_5tasks_til/independent/seed_${global_seed} global_seed=${global_seed}
# Finetuning
clarena pipeline=CUL_FULL_EXPR index=amnesiachat_paper/finetuning_rmnist_5tasks cl_paradigm=TIL output_dir=output_amnesiachat_paper/main_study/rmnist_5tasks_til/finetuning/seed_${global_seed} global_seed=${global_seed}
# LwF
clarena pipeline=CUL_FULL_EXPR index=amnesiachat_paper/lwf_rmnist_5tasks cl_paradigm=TIL output_dir=output_amnesiachat_paper/main_study/rmnist_5tasks_til/lwf/seed_${global_seed} global_seed=${global_seed}
# EWC
clarena pipeline=CUL_FULL_EXPR index=amnesiachat_paper/ewc_rmnist_5tasks cl_paradigm=TIL output_dir=output_amnesiachat_paper/main_study/rmnist_5tasks_til/ewc/seed_${global_seed} global_seed=${global_seed}
# DER
...
do
# Finetuning
clarena pipeline=CUL_FULL_EXPR index=amnesiachat_paper/finetuning_rmnist_5tasks cl_paradigm=DIL output_dir=output_amnesiachat_paper/main_study/rmnist_5tasks_dil/finetuning/seed_${global_seed} global_seed=${global_seed}
# LwF
clarena pipeline=CUL_FULL_EXPR index=amnesiachat_paper/lwf_rmnist_5tasks cl_paradigm=DIL output_dir=output_amnesiachat_paper/main_study/rmnist_5tasks_dil/lwf/seed_${global_seed} global_seed=${global_seed}
# EWC
clarena pipeline=CUL_FULL_EXPR index=amnesiachat_paper/ewc_rmnist_5tasks cl_paradigm=DIL output_dir=output_amnesiachat_paper/main_study/rmnist_5tasks_dil/ewc/seed_${global_seed} global_seed=${global_seed}
# DER
...
for global_seed in {1..5}
do
clarena pipeline=CUL_FULL_EXPR index=amnesiachat_paper/amnesiachat_pmnist_5tasks cl_paradigm=TIL output_dir=output_amnesiachat_paper/ablation_study/pmnist_5tasks_til/amnesiachat/seed_${global_seed} global_seed=${global_seed} cul_algorithm.if_backup_compensation=true cul_algorithm.if_replay_fixing=true

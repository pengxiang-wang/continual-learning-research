...
# AmnesiacHAT
clarena pipeline=CUL_FULL_EXPR index=amnesiachat_paper/amnesiachat_rmnist_5tasks cl_paradigm=DIL output_dir=output_amnesiachat_paper/main_study/rmnist_5tasks_dil/amnesiachatpp/seed_${global_seed}/${timestamp} global_seed=${global_seed}
done
